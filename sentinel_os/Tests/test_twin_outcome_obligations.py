...
def twin():
    ...
    # Every route this file exercises now checks the ship token (AC-13
    # fix); set it as a client default so existing calls that predate the
    # fix keep working without touching each call site individually.
